        ...
        <div className="max-w-xl mx-auto mt-10 mb-24">
          {conversation.length <= 0 && (
            <div className="space-y-4">
              <GenUICard />
              <Card className="p-4">
                <h3 className="font-semibold mb-2">Example Questions You Can Ask:</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Can you help me understand how to solve fraction word problems?</li>
                  <li>• Explain the model method for solving PSLE math questions</li>
                  <li>• What&apos;s the difference between ratio and proportion?</li>
            ...
            <Card className="p-2 shadow-lg">
              <div className="flex">
                <Input
                  ...
                  placeholder={isLoading ? 'Please wait...' : 'Ask me about PSLE math...'}
                />
                <Button
